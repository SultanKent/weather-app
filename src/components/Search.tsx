...
const Search = ({term, options,
  ...
  return (
    <main className="flex justify-center items-center h-[100vh] w-full">
      ...
      text-zinc-700">
        <h1 className="text-4xl font-thin ">Weather <span
        className="font-black">Forecast</span></h1>
        <p className="text-sm mt-2">Enter below a place(city) to u want to know
        the weather of and select an
        ...
        px-2 py-1 cursor-pointer" onClick={onSubmit}>search</button>
        </div>
      </section>
    </main>
  )
